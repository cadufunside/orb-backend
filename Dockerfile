...
# 2) Cria .npmrc DENTRO da imagem com timeouts e mirror rápido (Ásia)
#    (usar here-doc evita erros de barra, CRLF, etc.)
...
# 3) Gera lockfile e instala de forma determinística (tolerante a rede)
