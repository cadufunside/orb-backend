...
async function initializeWhatsApp(sessionId) {
    ...
    const client = new Client({
        ...
        // Re-injetando o Puppeteer extra com a configuração correta
        puppeteer: puppeteer.use(StealthPlugin()).launch({
    ...
    client.on('ready', async () => {
        ...
        try {
            ...
            // Sincronização LENTA (background)
...
// ... (Resto do Código: startServer, health, etc.)
